...
val WarmCream = Color(0xFFFFF8EF)
val SoftCream = Color(0xFFF4E9DA)
val Terracotta = Color(0xFFB85C48)
val SoftSage = Color(0xFFDDE5D6)
val DarkBrown = Color(0xFF382B27)
...
val BookshelfCozyBackground =  Color(0xFFF3E6D2)
val BookshelfCozyShelfBackground = Color(0xFFE8D9C8)
val BookshelfCozyWood = Color(0xFFA8754F)
